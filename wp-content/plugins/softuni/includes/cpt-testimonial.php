...
if ( ! class_exists( 'Softuni_Testimonials' ) ) :

	class Softuni_Testimonials {

	//the constructor of the class
		public function __construct() {
			add_action( 'init', array( $this, 'softuni_register_testimonials_cpt' ) );
		}
...
$softuni_testimonials = new Softuni_Testimonials();
